...
defprjdir='/netscratch/garyli/im_quality/defect_raw_projection/'
phanbase=argv[1]
age=phanbase[:2]
if phanbase[3]=='R':
   weightpercentile=50
...
if defloc_num == "1" :
 ...
 if age == '01' or age == '05' or age == '00':
  CorActIm=[defactmapdir,'unisex/',age,'/','def.',defloc,'.',phanbase,'.im'] #here use 1 defect actmap to keep act in cor low
  CorPrjIm=[defprjdir,'unisex/',age,'/',phanbase,'.',defloc,'.defprj.c.im']
  #OutPath=[sprjdir,'unisex/',age,'/',outfname]
 else:
  if gender=='M':
        CorActIm=[defactmapdir,'male/',age,'/','def.',defloc,'.',phanbase,'.im']
        CorPrjIm=[defprjdir,'male/',age,'/',phanbase,'.',defloc,'.defprj.c.im']
        #OutPath=[sprjdir,'male/',age,'/',outfname]
  else:
        CorActIm=[defactmapdir,'female/',age,'/','def.',defloc,'.',phanbase,'.im']
        CorPrjIm=[defprjdir,'female/',age,'/',phanbase,'.',defloc,'.defprj.c.im']
